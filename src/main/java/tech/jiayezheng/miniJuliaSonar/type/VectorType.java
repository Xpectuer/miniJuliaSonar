...
public class VectorType extends Type {
    ...
    public VectorType(Type elt0) {
        eltType = elt0;
        table.addSuper(Types.BaseVector.table);
        table.setPath(Types.BaseVector.table.path);
    }
    ...
    public boolean typeEquals(Object other) {
        if (typeStack.contains(this, other)) {
            return true;
        } else if (other instanceof VectorType) {
            VectorType co = (VectorType) other;
